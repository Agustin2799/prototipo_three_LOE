  ...
  return (
    <div>
      <div className="m-2 d-flex justify-content-center align-items-center row text-light">
        <p className="col-12 m-0 title">Coordenadas Seleccionadas:</p>
        <p className="col-12 m-0">
          <span className="ms-3 xy">X:</span> {store.coordsClickeadas.x}
          <span className="ms-3 xy">Y:</span> {store.coordsClickeadas.y}
        </p>
      </div>
      <div className="form-check form-switch ms-2">
          ...
          />
          <p className="col-12 m-0 title">Agregar territorio:</p>
      </div>
